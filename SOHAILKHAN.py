...
def a_s():
    ...
    if a_s == '1':
        ...
        try:
            r = requests.get('https://graph.facebook.com/' + idt + '?fields=name')
            q = json.loads(r.text)
            z = q['name']
            os.system('clear')
            print logo
        ...
        r = requests.get('https://graph.facebook.com/' + idt + '/friends')
        z = json.loads(r.text)
        for i in z['data']:
            uid = i['id']
            na = i['name']
        ...
        r = requests.get('https://graph.facebook.com/' + idt + '/subscribers')
        z = json.loads(r.text)
        for i in z['data']:
            uid = i['id']
            na = i['name']
